...
public class MyAdaptertwo extends RecyclerView.Adapter<MyAdaptertwo.MyViewHolder> {
    ...
    public MyAdaptertwo(Context context, ArrayList pname, ArrayList pquantity, ArrayList pprice, ArrayList equantity, ArrayList mobile, ArrayList email, ArrayList address) {
    ...
    View vv= LayoutInflater.from(context).inflate(R.layout.userentryo,parent,false);
